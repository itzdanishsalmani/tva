    ...
    return (
        <div className="h-screen w-screen p-4 ">
            <div className="custom-div relative ">
                <div className=" bg-orange-400 m-4 p-2 text-2xl md:text-4xl text-center font-bold ">HOW TO CONNECT WITH ME</div>
                <div className=" flex flex-col md:flex-row justify-evenly items-center mt-4 md:mt-12">
                <div className=" py-8 md:py-12 px-2 border-4 border-orange-400 shadow-lg shadow-orange-300 w-fit h-fit">
                <img src="mm1.webp" alt="" className="w-32 md:w-56"/>
                </div>
                
                <div className=" mt-4 md:mt-0 text-orange-400 space-y-3 md:space-y-6 text-xl md:text-3xl font-bold w-fit cursor-pointer "> 
